...
#### Registering with Office 365
 ...
 - Take note of the Client ID and the key you added. These are the Client ID and Client Secret, respectively, needed for the next step.
